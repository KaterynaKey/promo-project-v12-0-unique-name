                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:12px;padding-right:18px;padding-bottom:12px;padding-left:18px;word-break:break-word;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#28b628" role="presentation" style="border:1px solid #28b628;border-radius:3px;cursor:auto;font-style:normal;mso-padding-alt:10px 25px;background:#28b628;" valign="middle">
                                <a href="insertlink" style="display:inline-block;background:#28b628;color:#FFFFFF;font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;font-style:normal;font-weight:bold;line-height:1.5;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"> ${content} </a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
function downloadMjmlFile(content) {
    ...
    const a = document.createElement('a');
    a.href = URL.createObjectURL(file);
    a.download = `creative_${mjmlFileNumber}_mjml.html`;
    a.click();
    URL.revokeObjectURL(a.href);
}
